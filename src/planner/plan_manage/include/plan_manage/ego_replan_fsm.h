...
namespace ego_planner
{
  ...
  private:
    ...
    ros::Subscriber waypoint_sub_, odom_sub_, trigger_sub_, broadcast_ploytraj_sub_, mandatory_stop_sub_,broadcast_odom_sub;
    ...
    void RecvBroadcastOdomCallback(const nav_msgs::Odometry::ConstPtr &msg);
